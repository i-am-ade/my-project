...
import { Tooltip } from "react-tooltipster";
...
const About = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row  p-8 bg-cream">
        <div className="md:w-1/2 overflow-hidden transition-transform duration-300 ease-in transform scale-0 md:scale-100">
          <img
